...
public class AjoutAchatForm extends Form {
    ...
    public AjoutAchatForm(Resources res)  {
      ...
      add(skip);
                ...
                TextField NomClient = new TextField("", "nomClient",20, TextArea.TEXT_CURSOR);
                
                                TextField NumeroClient = new TextField("", "numeroClient",20, TextArea.TEXT_CURSOR);
       ...
       Button b7=new Button("liste Achat"); 
         setVisible(true);
...
*/
 ;
          ...
          this.add(Id).add(Date).add(NomClient).add(NumeroClient).add(save);
       ...
       p.setEmail(SessionManager.getEmail());*/
        ...
        add(b7);
         Form pre = null;
 b7.addActionListener(e -> new AchatForm(pre,res).show());                 
     }
}
