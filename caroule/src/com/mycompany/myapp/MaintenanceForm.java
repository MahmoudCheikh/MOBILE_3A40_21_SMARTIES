...
//  Resources themee = UIManager.initFirstTheme("/theme_1");
    ...
    {
           super("Maintenance Ajoutés",BoxLayout.y());
	...
	b2.setUIID("refresh"); 
        b2.addActionListener(l->new MaintenanceForm(Current,res).show());
        add(b2);  
                
                
             for (Maintenance p : new ServiceMaintenance().Add(p,previous, res)) {
